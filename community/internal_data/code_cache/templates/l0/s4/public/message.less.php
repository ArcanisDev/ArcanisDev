<?php
// FROM HASH: b428fb96268117bfc9656e8ddca8cd4d
return array(
...
.messageNotice
{
	...
	.xf-contentAccentBase();
	font-size: @xf-fontSizeSmaller;
	border-left: @xf-borderSizeMinorFeature solid @xf-borderColorHighlight;
	...
	&:before
	{
		...
		padding-right: .2em;
		font-size: 125%;
		color: fade(@xf-textColorAccentContent, 70%);
	}
...
.block--messages
{
	...
	{
		.xf-contentBase();
		border: @xf-borderSize solid #292D3D;
		border-radius: @xf-blockBorderRadius;
