<?php
// FROM HASH: 2fb4cf8ce9539bf1067cd73031b3b9f6
return array(
	...
	if ($__templater->func('property', array('dt_nodestat_simple', ), false)) {
		$__finalCompiled .= '
						<dl class="pairs pairs--rows">
							<dt>' . $__templater->filter($__vars['extras']['discussion_count'], array(array('number_short', array(1, )),), true) . (($__vars['extras']['discussion_count'] == $__vars['extras']['max_results']) ? '+' : '') . '</dt>
