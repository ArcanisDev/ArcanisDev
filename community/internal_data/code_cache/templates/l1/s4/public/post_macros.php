<?php
// FROM HASH: 0fbafc19e49342583d0032776c40e88c
return array(
...
'user_cell' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->func('property', array('dt_collapsible_extras', ), false) AND ($__templater->func('property', array('dt_messages_layout', ), false) == 'option1')) {
		$__finalCompiled .= '<span id="collapse-' . $__templater->escape($__vars['post']['post_id']) . '" class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-target="#js-post-' . $__templater->escape($__vars['post']['post_id']) . ' .message-userExtras"></span>';
	}
	$__finalCompiled .= '
					</div>
				';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '
	<article class="message ' . $__templater->escape($__templater->renderExtension('extra_classes', $__vars, $__extensions)) . ' js-post js-inlineModContainer ' . ((($__vars['post']['position'] % $__vars['xf']['options']['messagesPerPage']) == 0) ? 'is-first' : '') . ' ' . ($__templater->method($__vars['post'], 'isIgnored', array()) ? 'is-ignored' : '') . ' ' . ($__templater->method($__vars['post'], 'isUnread', array()) ? ' is-unread' : '') . '"
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
		...
		<ul class="message-attribution-opposite message-attribution-opposite--list ' . $__templater->escape($__vars['oppositeClass']) . '">
			';
	if (($__vars['post']['user_id'] == $__vars['thread']['user_id']) AND (($__templater->func('property', array('dt_thread_owner', ), false) != 'none'))) {
		$__finalCompiled .= '
				';
		if ($__templater->func('property', array('dt_thread_owner', ), false) == 'userbanner') {
			$__finalCompiled .= '
					<li class="messageOwner-Indicator">Thread Owner</li>
				';
		}
		$__finalCompiled .= '
			';
