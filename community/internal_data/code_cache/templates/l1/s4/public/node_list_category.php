<?php
// FROM HASH: 248310293f243be6880b1dc044e27113
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->func('property', array('dt_collapsible_categories', ), false)) {
		$__finalCompiled .= '
					<span id="collapse-' . $__templater->escape($__vars['node']['node_id']) . '" class="collapseTrigger collapseTrigger--block ' . ((!$__templater->func('is_toggled', array('_node-' . $__vars['node']['node_id'], ), false)) ? ' is-active' : '') . '" title="Toggle Visibilty" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-type="cookie" data-target=".block--category' . $__templater->escape($__vars['node']['node_id']) . ' .block-body" data-storage-key="_node-' . $__templater->escape($__vars['node']['node_id']) . '"></span>
				';
	}
	$__finalCompiled .= '
			</h2>
	...
	if ($__templater->func('property', array('dt_collapsible_categories', ), false)) {
		$__finalCompiled .= '
				<div class="block-body block-body--collapsible ' . ((!$__templater->func('is_toggled', array('_node-' . $__vars['node']['node_id'], ), false)) ? ' is-active' : '') . '">
			';
	} else {
		$__finalCompiled .= '
