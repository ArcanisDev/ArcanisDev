<?php
// FROM HASH: a54b5e29b0402ae58d8d2709f61e48e5
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '
    <!-- Check if user belongs to a specific group and apply styles -->
    ';
	if ($__templater->method($__vars['user'], 'isMemberOf', array(1, ))) {
		$__finalCompiled .= '
        <span class="username-group-1">' . $__templater->escape($__vars['user']['username']) . '</span>
    ';
	} else if ($__templater->method($__vars['user'], 'isMemberOf', array(5, ))) {
		$__finalCompiled .= '
        <span class="username-group-donors">' . $__templater->escape($__vars['user']['username']) . '</span>
    ';
	} else if ($__templater->method($__vars['user'], 'isMemberOf', array(3, ))) {
		$__finalCompiled .= '
        <span class="username-group-3">' . $__templater->escape($__vars['user']['username']) . '</span>
    ';
	} else {
		$__finalCompiled .= '
        <span class="username-default">' . $__templater->escape($__vars['user']['username']) . '</span>
    ';
	}
	$__finalCompiled .= '
';
...
<!-- Custom username styles based on user group -->
' . '
