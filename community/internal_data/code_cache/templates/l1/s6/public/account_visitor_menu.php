<?php
// FROM HASH: 2d7576e56a3fa03b59f86ef3fa1b4bf6
return array(
...
';
	...
	if ($__templater->func('property', array('dt_condense_visito_tabs', ), false)) {
		$__compilerTemp3 .= '
			<li><a href="' . $__templater->func('link', array('conversations', ), true) . '" class="menu-linkRow js-badge--conversations badgeContainer' . ($__vars['xf']['visitor']['conversations_unread'] ? ' badgeContainer--highlighted' : '') . '" data-badge="' . $__templater->filter($__vars['xf']['visitor']['conversations_unread'], array(array('number', array()),), true) . '">' . 'Conversations' . '</a></li>
			<li><a href="' . $__templater->func('link', array('account/alerts', ), true) . '" class="menu-linkRow js-badge--alerts badgeContainer' . ($__vars['xf']['visitor']['alerts_unread'] ? ' badgeContainer--highlighted' : '') . '" data-badge="' . $__templater->filter($__vars['xf']['visitor']['alerts_unread'], array(array('number', array()),), true) . '">' . 'Alerts' . '</a></li>
		';
	}
	$__compilerTemp4 = '';
