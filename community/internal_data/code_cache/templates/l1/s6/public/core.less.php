<?php
// FROM HASH: 2375d26d44f6e51812014c0655009e4b
return array(
...
' . $__templater->includeTemplate('core_dt_proprties.less', $__vars) . '
' . $__templater->includeTemplate('core_dt_extra.less', $__vars) . '
